...
import { legalArticleClassNamePrivacy } from '@/lib/legal-article-classes'

export const metadata: Metadata = {
  title: 'Privacy Policy | Zynterai',
  description: 'Privacy policy for zynterai.com — how we collect, use, and protect your information.',
}

export default function PrivacyPage() {
  return (
    <LegalPageShell variant="privacy">
      <article className={legalArticleClassNamePrivacy}>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                or &quot;Our&quot; in this Privacy Policy) refers to Zynter AI, 350 5th Ave, New York, NY 10118, United States.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Personal Data</strong> (or &quot;Personal Information&quot;) is any information that relates to
          ...
          <p>
            ...
            including, but not limited to, the type of mobile device You use, Your mobile device&apos;s unique ID, the
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>For business transfers:</strong> We may use Your Personal Data to evaluate or conduct a merger,
          ...
          <ul>
            ...
            <li>
              <strong>For business transfers:</strong> We may share or transfer Your Personal Data in connection with, or
              during negotiations of, any merger, sale of Company assets, financing, or acquisition of all or a portion of
              Our business to another company.
            </li>
            <li>
              <strong>With Affiliates:</strong> We may share Your Personal Data with Our affiliates, in which case we will
            ...
            <li>
              <strong>With business partners:</strong> We may share Your Personal Data with Our business partners to offer
              You certain products, services or promotions.
            </li>
            <li>
              <strong>With other users:</strong> If Our Service offers public areas, when You share Personal Data or
          ...
          <ul>
            ...
            <li>
              ...
              <ul>
                <li>
                  Website analytics data (cookies, IP addresses, device identifiers): up to 24 months from the date of
                  collection, which allows us to analyze trends while respecting privacy principles.
                </li>
                <li>
          ...
          <p>
            ...
            to appropriate safeguards and supplementary measures where appropriate. The Company will take all steps
          ...
          <ul>
            <li>
              ...
              <p>
                Mouseflow is a session replay and heatmap tool that shows how visitors click, move, scroll, browse, and pay
              ...
              <p>
                ...
                <a href="https://mouseflow.com/privacy/" target="_blank" rel="nofollow noopener noreferrer">
            ...
            <li>
              ...
              <p>
                ...
                <a href="https://www.freshworks.com/privacy/" target="_blank" rel="nofollow noopener noreferrer">
          ...
          <p>
            ...
            Data from anyone under the age of 16 without verification of parental consent, We take steps to remove that
