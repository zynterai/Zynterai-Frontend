...
import { legalArticleClassNameTerms } from '@/lib/legal-article-classes'

export const metadata: Metadata = {
  title: 'Terms and Conditions | Zynterai',
  description: 'Terms and conditions for using zynterai.com and our services.',
}

export default function TermsPage() {
  return (
    <LegalPageShell variant="terms">
      <article className={legalArticleClassNameTerms}>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                or &quot;Our&quot; in these Terms and Conditions) refers to Zynter AI, 350 5th Ave, New York, NY 10118, United States.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                Conditions, including any documents expressly incorporated by reference, which govern Your access to and
                use of the Service and form the entire agreement between You and the Company regarding the Service.
            ...
            <li>
              <p>
                ...
                information, products or services) provided by a third party that is displayed, included, made available,
                or linked to through the Service.
              </p>
            </li>
            <li>
              <p>
                <strong>Website</strong> refers to zynterai.com, accessible from{' '}
                <a href="https://zynterai.com/" target="_blank" rel="nofollow noopener noreferrer">
                  https://zynterai.com/
                </a>
              </p>
            </li>
          ...
          <p>
            Your access to and use of the Service is also subject to Our Privacy Policy, which describes how We collect,
            use, and disclose personal information. Please read Our Privacy Policy carefully before using Our Service.
          </p>
          ...
          <p>
            ...
            practices of any third-party websites or services. You further acknowledge and agree that the Company shall
          ...
          <p>
            You acknowledge and agree that the Company shall not be responsible or liable, directly or indirectly, for
            any damage or loss caused or alleged to be caused by or in connection with Your access to or use of any
            Third-Party Social Media Service, including any content, goods, or services made available through them. Your
            use of any Third-Party Social Media Service is governed by that Third-Party Social Media Service&apos;s
          ...
          <p>
            ...
            trade practice. Without limitation to the foregoing, the Company provides no warranty or undertaking, and makes
            no representation of any kind that the Service will meet Your requirements, achieve any intended results, be
          ...
          <ul>
            <li>By email: info@zynterai.com</li>
            <li>By phone: +1 212 735 8419</li>
            <li>By mail: 350 5th Ave, New York, NY 10118, United States</li>
          </ul>
      </article>
    </LegalPageShell>
  )
